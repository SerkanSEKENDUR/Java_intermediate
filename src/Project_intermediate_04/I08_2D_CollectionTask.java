...
public class I08_2D_CollectionTask {
    ...
    public static void main(String[] args) {
        ...
        calisanlar.add("Elif");
        calisanlar.add("Serkan");
        System.out.println("calisanlar = " + calisanlar);//calisanlar = [Erol, Ahmet, Emrah, Elif, Serkan]
        ...
        list.add(isverenler);
        list.add(sirketler);
        System.out.println(list);//[[Erol, Ahmet, Emrah, Elif, Serkan], [Haluk, Eylul, Yusuf, Can, Ibrahim, Mehmet], [Amazon, Google, Testinium, IBM]]
